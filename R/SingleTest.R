...
fuse_mul_1lam<-fusionGMM.addition(X_int,A_int,y_int,sum_mul,penalty_type = "lasso",summary_type = "multi",approx_cross_validation =T,tune_ratio = F,initial_with_GMM = T)
rmul1<-R2(y0,M0%*%fuse_mul_1lam$beta)
fuse_mul_1lam_2init<-fusionGMM.addition(X_int,A_int,y_int,sum_mul,penalty_type = "lasso",summary_type = "multi",approx_cross_validation =T,tune_ratio = F,initial_with_GMM = T)
rmul2<-R2(y0,M0%*%fuse_mul_1lam_2init$beta)
fuse_mul_1lam_3C<-fusionGMM.addition(X_int,A_int,y_int,sum_mul,penalty_type = "lasso",summary_type = "multi",approx_cross_validation =T,tune_ratio = F,desparseC = T)
rmul3<-R2(y0,M0%*%fuse_mul_1lam_3C$beta)
fuse_mul_1lam_2init_4C<-fusionGMM.addition(X_int,A_int,y_int,sum_mul,penalty_type = "lasso",summary_type = "multi",approx_cross_validation =T,tune_ratio = F,initial_with_GMM = T,desparseC = T)
